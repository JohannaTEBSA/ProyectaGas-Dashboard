...
def cargar_datos():
    ...
    archivos = {
        'pred_precios': r'C:\Users\jblanquicet\OneDrive - Tebsa\Documentos\AnalisisdeMercado\ProyectaGas\Datos\predicciones_futuras_2026.xlsx',
        'pred_demanda': r'C:\Users\jblanquicet\OneDrive - Tebsa\Documentos\AnalisisdeMercado\ProyectaGas\Datos\predicciones_2026_ensemble.xlsx',
        'historico_precios': r'C:\Users\jblanquicet\OneDrive - Tebsa\Documentos\AnalisisdeMercado\ProyectaGas\Datos\df_completo_procesado.csv',
        'historico_demanda': r'C:\Users\jblanquicet\OneDrive - Tebsa\Documentos\AnalisisdeMercado\ProyectaGas\Datos\Data_Demanda.xlsx',  # Datos hasta enero 2026
    }
...
def main():
    ...
    st.markdown("**Sistema de Predicción de Demanda y Precios de Gas Natural | TPLGas**")
    ...
    # Tabs principales
    tab1, tab2, tab3 = st.tabs(["💵 Precios Internacionales", "📊 Demanda Total", "🏭 Sectores"])
    ...
    <div style='text-align: center; color: gray; padding: 20px;'>
        <p>⚡ ProyectaGAS - Sistema de Predicción de Demanda y Precios</p>
        <p>TPLGas | Febrero 2026 | Desplegado en Streamlit Cloud</p>
    </div>
    """, unsafe_allow_html=True)
